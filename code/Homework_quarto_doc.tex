...
\FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data =}\NormalTok{ kelp, }
  ...
  \CommentTok{\# second layer: adding trend line with color and standard error}
  \FunctionTok{geom\_smooth}\NormalTok{(}\AttributeTok{method =} \StringTok{"lm"}\NormalTok{,}
              \AttributeTok{color =} \StringTok{"\#e76f51"}\NormalTok{, }
...
\pandocbounded{\includegraphics[keepaspectratio]{Homework_quarto_doc_files/figure-pdf/unnamed-chunk-2-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{Homework_quarto_doc_files/figure-pdf/unnamed-chunk-3-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{Homework_quarto_doc_files/figure-pdf/unnamed-chunk-3-2.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{Homework_quarto_doc_files/figure-pdf/unnamed-chunk-7-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{Homework_quarto_doc_files/figure-pdf/unnamed-chunk-8-1.pdf}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{./Users/michaeltorbensen/git/ENVS-193DS_homework-03/ANOVA_test.png}}

}

\caption{ANOVA Table showing nitrate levels over time in four water
sources}
